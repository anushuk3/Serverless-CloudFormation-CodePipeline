...
def lambda_handler(event, context):
    ...
    def main():
        ...
        insert_data('Computer Science', 'CS00001', 'Computer Science CS00001', 11)
        insert_data('Computer Science', 'CS00002', 'Computer Science CS00002', 12)
        #Full table scan and fetch all the data
        #fetch_all()
        #Get a single record that does not exist
        #fetch_data('Computer Science', 'CS00001')
        #Update a single record
        update_data('Computer Science', 'CS00002', 13)
        ...
        insert_data('Data Science', 'DS00004', 'Data Science DS00004', 14)
        insert_data('Data Science', 'DS00005', 'Data Science DS00005', 15)
        insert_data('Data Science', 'DS00006', 'Data Science DS00006', 16)
